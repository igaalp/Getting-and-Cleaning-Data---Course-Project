...
#retrieveing the names of "test" and "train" files for the folder "Inertial Signals",  
testfiles<-list.files(path="~/test/Inertial Signals")
trainfiles<-list.files(path="~/train/Inertial Signals")

#Gathering Intnertial Signals (train and test) into one table for each variable  ( optional)
